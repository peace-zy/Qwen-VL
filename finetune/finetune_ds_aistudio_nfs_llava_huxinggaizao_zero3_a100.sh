...
${TORCHRUN_BIN} $DISTRIBUTED_ARGS finetune.py \
    ...
    --bf16 True \
    --fix_vit True \
    --output_dir output_qwen_new_llava_huxinggaizao_zero3_a100_2048 \
    --num_train_epochs 5 \
    ...
    --log_level "debug" \
    --deepspeed finetune/ds_config_zero3_a100.json > ${LOG_PATH}"/"llava_huxinggaizao_zero3_a100_2048_${LOG_NAME}".log" 2>&1
