...
export PATH=/aistudio/workspace/system-default/envs/pytorch_2.1.0_cu12.1_py3.11_qwen_vl/bin:$PATH
export LD_LIBRARY_PATH=/aistudio/workspace/system-default/envs/pytorch_2.1.0_cu12.1_py3.11_qwen_vl/lib/python3.11/site-packages/torch/lib:$LD_LIBRARY_PATH
echo ${PATH}
...
TORCHRUN_BIN="/aistudio/workspace/system-default/envs/pytorch_2.1.0_cu12.1_py3.11_qwen_vl/bin/torchrun"
check ${TORCHRUN_BIN}
...
${TORCHRUN_BIN} $DISTRIBUTED_ARGS finetune.py \
    ...
    --bf16 True \
    --fix_vit False \
    --output_dir output_qwen_new_llava_huxinggaizao_zero3_a100_2048_vit_on \
    --num_train_epochs 5 \
    ...
    --log_level "debug" \
    --deepspeed finetune/ds_config_zero3_a100.json > ${LOG_PATH}"/"llava_huxinggaizao_zero3_a100_2048_vit_on${LOG_NAME}".log" 2>&1
