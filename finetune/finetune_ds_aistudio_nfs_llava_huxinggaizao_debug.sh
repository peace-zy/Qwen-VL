...
${ROOT}/zhangyan461/env/pytorch_2.1.0_cu12.1_py3.11_qwen_vl/bin/python -m pip install -U transformers==4.32.0 -i http://pypi.douban.com/simple/ --trusted-host pypi.douban.com
${ROOT}/zhangyan461/env/pytorch_2.1.0_cu12.1_py3.11_qwen_vl/bin/python -m pip list |grep transformers
check ${TORCHRUN_BIN}
...
${TORCHRUN_BIN} $DISTRIBUTED_ARGS finetune.py \
    ...
    --bf16 True \
    --fix_vit True \
    --output_dir output_qwen_new_llava_huxinggaizao_debug \
    --num_train_epochs 2 \
    ...
    --log_level "debug" \
    --deepspeed finetune/ds_config_zero2_debug.json > ${LOG_PATH}"/"llava_huxinggaizao_${LOG_NAME}".log" 2>&1
